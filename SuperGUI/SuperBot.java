...
public class SuperBot {
	...
	public int contains(Point p, int index) {
		// bot collision
		if (Math.sqrt(Math.pow(p.x - this.p.x, 2) + Math.pow(p.y - this.p.y, 2)) <= SuperGUI.ROBOT_DIAMETER / 2 * SuperGUI.SCALE) return index;

		// path collision
		if (next != null && alpha > 50) {
			double angle = Math.atan2(-next.getPoint().y + this.p.y, next.getPoint().x - this.p.x);
			Polygon path = new Polygon(new int[] { this.p.x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle + Math.PI / 2)),
					this.p.x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle - Math.PI / 2)),
					next.getPoint().x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle - Math.PI / 2)),
					next.getPoint().x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle + Math.PI / 2)) },

					new int[] { this.p.y - (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.sin(angle + Math.PI / 2)),
							this.p.y - (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.sin(angle - Math.PI / 2)),
							next.getPoint().y - (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.sin(angle - Math.PI / 2)),
							next.getPoint().y - (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.sin(angle + Math.PI / 2)) },
	...
	public void draw(Graphics g, int alpha) {
		...
		if (next != null) {
			double angle = Math.atan2(-next.getPoint().y + p.y, next.getPoint().x - p.x);

			// draw path to next bot
			g.setColor(new Color(255, 155, 0, alpha));
			Polygon path = new Polygon(new int[] { p.x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle + Math.PI / 2)),
					p.x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle - Math.PI / 2)),
					next.getPoint().x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle - Math.PI / 2)),
					next.getPoint().x + (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.cos(angle + Math.PI / 2)) },

					new int[] { p.y - (int) (.5 * SuperGUI.ROBOT_WIDTH * SuperGUI.SCALE * Math.sin(angle + Math.PI / 2)),
			...
			if (arrowSize > SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE / 2.0) arrowSize = SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE / 2.0;
			g.drawPolyline(new int[] { p.x + (int) (distance * 2 / 5 * Math.cos(angle)), p.x + (int) (distance * 3 / 5 * Math.cos(angle)),
					p.x + (int) (distance * 3 / 5 * Math.cos(angle) + arrowSize * Math.cos(angle + Math.PI * 5 / 6)), p.x + (int) (distance * 3 / 5 * Math.cos(angle)),
					p.x + (int) (distance * 3 / 5 * Math.cos(angle) + arrowSize * Math.cos(angle - Math.PI * 5 / 6)) },

					new int[] { p.y - (int) (distance * 2 / 5 * Math.sin(angle)), p.y - (int) (distance * 3 / 5 * Math.sin(angle)),
							p.y - (int) (distance * 3 / 5 * Math.sin(angle) + arrowSize * Math.sin(angle + Math.PI * 5 / 6)), p.y - (int) (distance * 3 / 5 * Math.sin(angle)),
							p.y - (int) (distance * 3 / 5 * Math.sin(angle) + arrowSize * Math.sin(angle - Math.PI * 5 / 6)) },
		...
		g.fillOval(p.x - (int) (SuperGUI.ROBOT_DIAMETER / 2 * SuperGUI.SCALE), p.y - (int) (SuperGUI.ROBOT_DIAMETER / 2 * SuperGUI.SCALE),
		...
		if (next != null) {
			...
			g.fillPolygon(new int[] { p.x + (int) (.5 * SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE * Math.cos(cornerAngle + angle)),
					...
					new int[] { p.y - (int) (.5 * SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE * Math.sin(cornerAngle + angle)),
							...
							p.y - (int) (.5 * SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE * Math.sin(Math.PI + cornerAngle + angle)),
							p.y - (int) (.5 * SuperGUI.ROBOT_DIAMETER * SuperGUI.SCALE * Math.sin(Math.PI + angle - cornerAngle)) },
			...
			g.drawPolyline(new int[] { p.x + (int) (distance * 2 / 5 * Math.cos(angle + Math.PI)), p.x + (int) (distance * 3 / 5 * Math.cos(angle)),
					p.x + (int) (distance * 3 / 5 * Math.cos(angle) + arrowSize * Math.cos(angle + Math.PI * 5 / 6)), p.x + (int) (distance * 3 / 5 * Math.cos(angle)),
					p.x + (int) (distance * 3 / 5 * Math.cos(angle) + arrowSize * Math.cos(angle - Math.PI * 5 / 6)) },

					new int[] { p.y - (int) (distance * 2 / 5 * Math.sin(angle + Math.PI)), p.y - (int) (distance * 3 / 5 * Math.sin(angle)),
							p.y - (int) (distance * 3 / 5 * Math.sin(angle) + arrowSize * Math.sin(angle + Math.PI * 5 / 6)), p.y - (int) (distance * 3 / 5 * Math.sin(angle)),
							p.y - (int) (distance * 3 / 5 * Math.sin(angle) + arrowSize * Math.sin(angle - Math.PI * 5 / 6)) },
