...
public class Ports {
	...
	public static final int GEAR_MOTOR = 9; //temp

	public static final int LEFT_JOYSTICK = 0;
	public static final int RIGHT_JOYSTICK = 1;
	public static final int XBOX = 9; //temp
	
	public static final int GEAR_DOWN_BUTTON = 9; //temp
	public static final int GEAR_UP_BUTTON = 0; //temp
