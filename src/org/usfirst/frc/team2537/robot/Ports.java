...
public class Ports {
	...
	// Drive Talon Ports
	public static final int FRONT_LEFT_MOTOR = 60, FRONT_RIGHT_MOTOR = 2, BACK_LEFT_MOTOR = 3, BACK_RIGHT_MOTOR = 61;

	// Mechanism Talon Ports
	public static final int CLIMBER_MOTOR_ONE = 0, CLIMBER_MOTOR_TWO = 62;

	public static final int INTERIOR_SHOOTER = 1, EXTERIOR_SHOOTER = 5; // originally 3 and 2
