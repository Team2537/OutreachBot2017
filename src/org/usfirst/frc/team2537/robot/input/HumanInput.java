...
public class HumanInput {
	...
	public static JoystickButton cameraSelection = new JoystickButton(xboxController, Ports.CAMERA1_MODE_ON);                           
	public static JoystickButton cameraOption = new JoystickButton(xboxController, Ports.CAMERA2_MODE_ON);                           
